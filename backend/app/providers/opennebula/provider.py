...
class OpenNebulaProvider(CloudProvider):
    """Future OpenNebula implementation of the common cloud provider contract."""

    def status(self) -> dict[str, Any]:
        raise NotImplementedError("OpenNebula provider is not implemented yet")
