...
class CloudStackProvider(CloudProvider):
    """Future CloudStack implementation of the common cloud provider contract."""

    def status(self) -> dict[str, Any]:
        raise NotImplementedError("CloudStack provider is not implemented yet")
